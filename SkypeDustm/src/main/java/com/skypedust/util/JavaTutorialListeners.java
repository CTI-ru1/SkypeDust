...
/*
 * import com.skype.api.Voicemail.PROPERTY;
 */
...
public class JavaTutorialListeners implements 
	 ...
	 * @since 1.0
	 * 
	 * @see com.skype.api.Video.VideoListener#OnLastFrameCapture(com.skype.api.SkypeObject, byte[], int, int)
	 */
	public void OnLastFrameCapture(com.skype.api.SkypeObject obj, byte[] image, int width, int height) {
		// TODO Auto-generated method stub
		Log.d("Tutorial", "OnLastFrameCapture(image.len(" + image.length + "), " + width + ", " + height + ")");
	}
